# متن و اسکرین شات آماده App Store
...
Subtitle:
Solo Rift Arena Battles

Promotional Text:
Enter quick 3D solo arena battles. Collect Rift Shards, trigger Surge bursts, chain streaks, earn coins, and beat your best score.

Keywords:
solo,arena,action,shooter,platformer,rift,surge,shards,offline,ai,coins,streak,3D,battle

## Description

Void Spheres: Riftbound is a fast 3D arena battler built for quick mobile matches.
...
## اسکرین شات های آماده

همه در این مسیر هستند:
`marketing/app-store-screenshots/`

ترتیب پیشنهادی برای آپلود:
...
2. `02-live-arena.png`
   ...
   کاربرد: بهترین عکس برای معرفی ظاهر سیاره‌ها، گربه‌ها و HUD لمسی.

3. `03-aim-fire.png`
   متن روی عکس: Aim. Fire. Interrupt.
   کاربرد: تاکید روی شلیک، دشمن‌های گربه و کنترل لمسی.

4. `04-streak-coins.png`
   متن روی عکس: Phase Dash Through Fire
   کاربرد: نشان دادن Phase Dash، بازخورد رزمی و جاخالی از پرتابه‌ها.

5. `05-two-minute-score.png`
   متن روی عکس: Leap Between Worlds
   کاربرد: نشان دادن پرش بلند و جابه‌جایی بین سیاره‌ها.

## توضیح فارسی برای خودت
...
- کنترل لمسی مخصوص موبایل
- امتیاز، streak، coin و daily target برای برگشت دوباره بازیکن
